...
Below is an alphabetical list of supported emojis and the shortcodes you can use 
to show them in your text. If you want to add any emojis that are not already
present you can do so in the [emojis.json](./emojis.json) file. 
...
The emoji shortcode list above originated from <https://gist.github.com/rxaviers/7360908>
